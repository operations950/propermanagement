...
def notify_assignee(visit, request=None):
    ...
    `request` is only used to build the link's address; without one (a
    visit generated by a recurring rule, off the scheduler) the address
    comes from settings.SITE_BASE_URL."""
