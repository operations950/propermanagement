...
class PropertySupply(models.Model):
    """Which items a given property stocks, and how many to buy when a
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['property', 'supply_item'], name='uniq_property_supply_item'),
        ]
        verbose_name_plural = 'property supplies'

    def __str__(self):
        return f'{self.supply_item} @ {self.property}'
